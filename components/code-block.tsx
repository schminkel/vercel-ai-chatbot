...
export function CodeBlock({
  ...
  if (!isInlineCode) {
    ...
    return (
      <div className="not-prose flex flex-col my-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-xl overflow-hidden w-full max-w-[calc(100vw-3rem)] sm:max-w-[685px] mx-auto">
