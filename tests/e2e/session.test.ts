      ...
      .serial('Database Operations', () => {
        ...
        test('Add email to Allowed_User table', async () => {
          ...
          try {
            ...
            console.log(
              `✅ Successfully added ${testEmail} to Allowed_User table`,
            );
          } finally {
        ...
        test('Remove demo@demo.de from Allowed_User table', async () => {
          ...
          console.log(
            `✅ Successfully removed ${testEmail} from Allowed_User table`,
          );
        });
        ...
        test('Complete workflow: Create and delete user with all constraints', async () => {
          ...
          try {
            ...
            console.log(
              `✅ Successfully completed full workflow for ${testEmail}`,
            );
          } catch (error) {
